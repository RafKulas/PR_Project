...
//    }
    ...
    for (int i = 0; i < data->players_index; ++i)
    {
        ...
        printf("data.players[i].player_rect.size = %d\n", data->players[i].player_rect.size);
        printf("data.players[i].player_rect.game_result = %d\n", data->players[i].player_rect.game_result);
